...
class CurrencyCore extends ObjectModel
{
	...
	/**
	 * Convert common weight's to ounces, helper for gold/silver price calculations in refreshCurrencies()
	 *
	 */	
	public static function convertToOunces($weightValue, $weightString)
	{
		$weightString = strval($weightString);
		...
		switch ($weightString) {
			...
			case "lb":
			case "lbs":
				$newWeightValue = $weightValue/0.0625;
				break;
			case "stones":
			case "stone":
			case "st":
				$newWeightValue = $weightValue/0.004464285714;
				break;
			case "tons":
			case "t":
				$newWeightValue = $weightValue/0.00003125;
				break;
			case "metric-tons":
			case "t":
			case "mt":
			case "mts":
				$newWeightValue = $weightValue/0.00002834952313;
				break;						
			case "milligrams":
			case "mg":
			case "mgs":
				$newWeightValue = $weightValue/28349.52313;
				break;	
			case "centigrams":
			case "cg":
			case "cgs":
				$newWeightValue = $weightValue/2834.952313;
				break;	
			case "gram":
			case "grams":
			case "g":
			case "gr":
				$newWeightValue = $weightValue/28.34952313;
				break;	
			case "kilograms":
			case "kg":
			case "kgs":
				$newWeightValue = $weightValue/0.02834952313;
				break;
			default:
				break;																												
		}
		return 	$newWeightValue;
	}
